...
export const CONTENT = {
  ...
  contextIntroScene: {
    narration: [
      ...
      "이 상황을 프로그래밍에서는 맥락, 영어로 [context(발음:컨텍스트)]라고 합니다.",
    ],
  },
  carExampleScene: {
    narration: [
      "예를 들어, 속력이 30인 자동차와 속력이 230인 자동차가 있습니다.",
      "두 자동차가 똑같이 [2번(발음:두번)] 주행하면, 주행거리[(마일리지)(발음:)]는 완전히 다릅니다.",
  ...
  personClassScene: {
    narration: [
      ...
      "이름, 나이, 키, 성별을 필드로 갖고, [introduce(발음:인트로듀스)]라는 메서드를 가진 [Person(발음:퍼슨)] 클래스입니다.",
    ],
  },
  personExampleScene: {
    narration: [
      "철수는 25살 남성이고, 영희는 22살 여성입니다.",
      "둘 다 똑같은 [introduce(발음:인트로듀스)]를 호출하지만, 출력 결과는 전혀 다릅니다.",
