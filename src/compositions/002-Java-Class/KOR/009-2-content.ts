...
export const CONTENT = {
  ...
  exampleScene: {
    narration: [
      "현실적인 예를 들어보겠습니다.",
      "[balance(발음:밸런스)]는 인스턴스 변수이고, [amount(발음:어마운트)]와 [newBal(발음:뉴 밸)]은 지역변수입니다.",
      "[deposit(발음:디파짓)] 1000을 호출하면 지역변수가 생기고, 메서드가 끝나면 사라집니다.",
      "하지만 [balance(발음:밸런스)]는 1000이 그대로 남아있습니다.",
      "한 번 더 [deposit(발음:디파짓)] 500을 호출하면, 지역변수는 다시 새로 생깁니다.",
      "메서드가 끝나면 지역변수는 또 사라지지만, [balance(발음:밸런스)]만 1500으로 유지됩니다.",
    ],
  },
  summaryScene: {
    narration: [
