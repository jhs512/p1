...
export const SRT_DATA: Array<{ startFrame: number; endFrame: number; text: string }> = (() => {
  ...
  addScene(froms[3], VIDEO_CONFIG.whileScene.narration, AUDIO_CONFIG.whileScene.speechStartFrame,
  ...
  // [5]=infiniteScene
  addScene(froms[5], VIDEO_CONFIG.infiniteScene.narration, AUDIO_CONFIG.infiniteScene.speechStartFrame,
  ...
  // [6]=summaryScene
  addScene(froms[6], VIDEO_CONFIG.summaryScene.narration, AUDIO_CONFIG.summaryScene.speechStartFrame,
