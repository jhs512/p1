...
addScene(
  froms[2] + declarationDur - SCENE_TAIL_FRAMES,
  narrations.initialization,
...
addScene(
  froms[4] + qDur + QUIZ_THINKING_FRAMES,
  narrations.interpretReveal,
