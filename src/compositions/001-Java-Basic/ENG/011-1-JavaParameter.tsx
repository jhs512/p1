  ...
  return (
    ...
    >
      ...
      >
        Java
        <br />
        <span style={{ color: C_TEAL }}>Parameters</span>
      </div>
      {/* 배지: Parameters & Argument */}
      <div style={{ display: "flex", gap: 20, marginTop: 8 }}>
        {["Parameters", "Argument"].map((label) => (
          <div
            key={label}
            style={{
              fontFamily: uiFont,
    ...
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          ...
          <SceneTitle title="1. Fixed Function" />
          <div
            style={{
              position: "absolute",
              top: "45%",
  ...
  return (
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          <Audio src={staticFile(cfg.audio)} />
          <SceneTitle title="2. What Is a Parameter?" />
          <div
            style={{
              position: "absolute",
              top: "45%",
          ...
          >
            ...
            >
              The slot that receives a{" "}
              <span style={{ color: C_FUNC, fontWeight: 700 }}>value</span>
            </div>
          </div>
        </ContentArea>
      </AbsoluteFill>
...
// ── 씬: ParamScene — Parameter Declaration ──────────────────────────
const PARAM_LINES = [
...
// greet 함수 첫 줄 — "String name" Parameters에 밑줄
...
const ParamScene: React.FC = () => {
  ...
  // 라벨 "← Parameters": split + 12프레임 후 등장
  ...
  return (
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          <Audio src={staticFile(cfg.audio)} />
          <SceneTitle title="3. Parameter Declaration" />
          <div
            style={{
              position: "absolute",
              top: "45%",
...
// ── 씬: MultiParamScene — 여러 Parameters ─────────────────────
...
// 첫 줄 — "int a, int b" Parameters에 밑줄
  ...
  return (
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          <Audio src={staticFile(cfg.audio)} />
          <SceneTitle title="5. Multiple Parameters" />
          <div
            style={{
              position: "absolute",
              top: "42%",
...
// ── 씬: ArgParamScene — Argument vs Parameters 비교 ──────────────
  ...
  return (
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          <Audio src={staticFile(cfg.audio)} />
          <SceneTitle title="6. Argument vs Parameter" />
          <div
            style={{
              position: "absolute",
              top: "42%",
