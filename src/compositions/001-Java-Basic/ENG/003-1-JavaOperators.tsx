...
const C_NUM = C_NUMBER; // 숫자 리터럴 (quotient 등)
const C_REM = C_TEAL; // remainder(%) 강조
  ...
  return (
    ...
    >
      ...
      >
        Java
        <br />
        <span style={{ color: C_TEAL }}>Arithmetic Operators</span>
      </div>
      <div
        style={{
          ...monoStyle,
    ...
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          ...
          <SceneTitle title="1. What Are Arithmetic Operators?" />
          <div
            style={{
              position: "absolute",
              top: "46%",
    ...
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          ...
          <SceneTitle title="2. Addition and Subtraction" />
  ...
  return (
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          <Audio src={staticFile(cfg.audio)} />
          <SceneTitle title="3. Multiplication and Division" />
          {frame >= s && (
            <CodeLines
              lines={[
                { text: "int a = 10, b = 3;", startFrame: s },
                ...
                {
                  text: "// Whole-number division drops the decimal part.",
                  startFrame: split1,
                },
              ]}
            />
...
const RemScene: React.FC = () => {
  ...
  // split0: quotient/remainder 강조 등장
  ...
  return (
    <>
      <AbsoluteFill style={{ background: BG, opacity }}>
        <ContentArea>
          <Audio src={staticFile(cfg.audio)} />
          <SceneTitle title="4. Remainder Operator" />
