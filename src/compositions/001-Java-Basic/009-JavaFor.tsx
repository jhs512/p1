...
const ForScene: React.FC = () => {
  ...
  return (
    <>
      ...
      <Subtitle sentences={cfg.narration} splits={cfg.narrationSplits} speechStart={s} wordFrames={AUDIO_CONFIG.forScene.wordStartFrames} />
    </>
  );
};
...
export const SRT_DATA: Array<{ startFrame: number; endFrame: number; text: string }> = (() => {
  ...
  // [3]=forScene
  addScene(froms[3], VIDEO_CONFIG.forScene.narration, AUDIO_CONFIG.forScene.speechStartFrame,
    AUDIO_CONFIG.forScene.narrationSplits, AUDIO_CONFIG.forScene.sentenceEndFrames,
    VIDEO_CONFIG.forScene.durationInFrames);
  // [4]=executionScene
  addScene(froms[4], VIDEO_CONFIG.executionScene.narration, AUDIO_CONFIG.executionScene.speechStartFrame,
