...
const ThumbnailScene: React.FC = () => (
  ...
  >
    ...
    >
      Java
      <br />
      <span style={{ color: C_WHILE }}>반복문</span>
    </div>
    {/* while 키워드 */}
    <div
      style={{
          ...
          return (
            <span
              ...
              style={{
                ...
                // count++ 강조: 배경 하이라이트
                background:
                  isCountPlusPlus && pi === 0 ? `${C_TEAL}18` : undefined,
          ...
          >
            ...
            >
              {CODE_LINES.map((line, i) =>
                renderLine(line, lineVisibility[i], i),
              )}
            </div>
          </div>
        )}
      ...
      <AbsoluteFill style={{ background: "#1e1e1e", opacity }}>
        ...
        {frame >= s && (
          ...
          >
            ...
            >
              <div style={{ color: C_INT }}>
                int <span style={{ color: "#d4d4d4" }}>count = </span>
          ...
          {SUMMARY_ROWS.map((row, i) => {
            ...
            return (
              ...
              >
                ...
                <span
                  style={{ fontFamily: uiFont, fontSize: 28, color: "#d4d4d4" }}
                >
                  {row.desc}
                </span>
              </div>
